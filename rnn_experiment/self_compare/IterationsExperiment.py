...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if sys.argv[1] == 'exp':
            ...
            if len(sys.argv) > 3:
                ...
                continue_pickle = ''
            run_all_experiments(net, points, t_range, other_idx_method, gurobi_ptr, steps_num=100, continue_pickle=continue_pickle)
        exit(0)
    ...
    # run_all_experiments([net], [point], t_range, other_idx_method, gurobi_ptr)
