...
def run_experiment(in_tensor, radius, idx_max, other_idx, h5_file, max_iterations=100):
    ...
    for i in range(2, max_iterations):
        ...
        our_time = adversarial_query(in_tensor, radius, idx_max, other_idx, h5_file, IterateAlphasSGD, i)
...
experiemnts = [
    ...
    {'idx_max': 13, 'other_idx': 15,
     ...
     'h5_path': "{}/model_classes20_1rnn4_0_2_4.h5".format(MODELS_FOLDER), 'n_iterations': 12},
    {'idx_max': 9, 'other_idx': 2,
     'in_tensor': [10] * 40, 'radius': 0.01,
     'h5_path': "{}/model_classes20_1rnn2_0_64_4.h5".format(MODELS_FOLDER), 'n_iterations': 12},
]
...
if __name__ == "__main__":
    ...
    for exp in experiemnts:
        ...
        exp_name = exp['h5_path'].split('/')[-1].split('.')[0] + '_' + str(exp['n_iterations'])
