...
def define_sum_output_equations(network, ylim, n_iterations):
    '''
    ...
    # TODO: seems like the slack param added in the invariant equations is still here make sure and fix if needed
    # Add the slack variable, i
    # print(start_param)
    # query.setLowerBound(5, 0)
    # query.setUpperBound(5, n_iterations)
...
def define_sum_network(xlim=(-1, 1)):
    ...
    sum_rnn_query.setNumberOfVariables(num_params_for_cell)  # + extra_params)
    ...
    # y
    sum_rnn_query.setLowerBound(4, -large)
    ...
    # base_invariant_equations, step_invariant_equations = define_sum_invariant_equations(sum_rnn_query)
    # return sum_rnn_query, base_invariant_equations, step_invariant_equations
    return sum_rnn_query


def prove_invariant(xlim=(-1, 1), network_define_f=define_sum_network,
                    invarinet_define_f=define_sum_invariant_equations):
    '''
...
if __name__ == "__main__":
    ...
    print('result:',
          prove_using_invariant(invariant_xlim, y_lim, num_iterations, define_sum_network,
                                define_sum_invariant_equations,
                                define_sum_output_equations))
