...
const unsigned GlobalConfiguration::CONSTRAINT_VIOLATION_THRESHOLD = 0;
const unsigned GlobalConfiguration::SPLITTING_HEURISTICS = DivideStrategy::EarliestReLU;
